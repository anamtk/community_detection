...
data <- readRDS("/scratch/atm234/sev_hoppers/inputs/a0/sev_msam_dynmultisite.RDS")
...
mod <- jagsUI::jags(data = data_list,
                    inits = inits,
                    #inits = NULL,
                    model.file = '/scratch/atm234/sev_hoppers/inputs/a0/sev_MSAM_simple_nocova0.R',
...
saveRDS(mod, 
        file ="/scratch/atm234/sev_hoppers/outputs/a0/sev_MSAM_nocovRE_model.RDS")
...
mcmcplot(mod$samples,
         parms = params2,
         dir = "/scratch/atm234/sev_hoppers/outputs/a0/mcmcplots/MSAM_nocovRE")

# Get RHat per parameter ------------------------------------------------

Rhat <- mod$Rhat

saveRDS(Rhat, "/scratch/atm234/sev_hoppers/outputs/a0/sev_MSAMnocovRE_model_Rhat.RDS")
