...
#daily climate
climate <- read.csv(here('examples',
                         'data_raw',
                         'bird_fundiv',
                         'AWE012.csv'))
...
konza_obs <- readRDS(here('examples',
                          'data_output',
                          'bird_fundiv',
                          'tidy_data',
                          'bird_fd_metrics_raw.RDS')) %>%
  mutate(TransID =as.numeric(TransID),
...
all_data2 <- all_data %>%
  left_join(konza_obs, by = c("yrID", "TransID"))
...
write.csv(all_data2, here('examples',
                          'data_output',
                          'bird_fundiv',
                          'tidy_data',
