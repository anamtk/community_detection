...
meta <- read.csv(file = "/scratch/atm234/sev_hoppers/inputs/grasshopper_msam_tidy_data.csv")

#load the formatted data for the JAGS model
data <- readRDS("/scratch/atm234/sev_hoppers/inputs/sev_msam_dynmultisite.RDS")

# Update model to track N ----------------------------------------------
...
bray_df <- rbind(bray_list)

saveRDS(bray_df, file = "/scratch/atm234/sev_hoppers/outputs/a0/sev_bray_df.RDS")
