...
mod <- readRDS(file ="/scratch/atm234/sbc_fish/SAM/raw/outputs/raw_fish_SAM_model.RDS")
...
sig.site <- as.vector(samp_df2$sig.web)
...
data <- readRDS("/scratch/atm234/sbc_fish/SAM/raw/inputs/bray_SAM_input_data_raw.RDS")
...
inits <- list(list(b0 = b0,
              ...
              list(b0 = b0 + 0.05,
                   b = b + 0.5,
                   sig.site = sig.site + 0.01,
                   sig.transect = sig.transect + 0.01,
                   deltaA = deltaA + 0.01,
                   deltaB = deltaB + 0.01),
              list(b0 = b0 - 0.05,
                   b = b - 0.5,
                   sig.site = sig.site + 0.04,
...
mod <- jagsUI::jags(data = data_list,
                    inits = inits,
                    #inits = NULL,
                    model.file = '/scratch/atm234/sbc_fish/SAM/raw/inputs/raw_fish_SAM.R',
...
saveRDS(mod, 
        file ="/scratch/atm234/sbc_fish/SAM/raw/outputs/fish_SAM_model2.RDS")
...
mcmcplot(mod$samples,
         dir = "/scratch/atm234/sbc_fish/SAM/raw/outputs/mcmcplots/SAM2")

# Get RHat per parameter ------------------------------------------------

Rhat <- mod$Rhat

saveRDS(Rhat, "/scratch/atm234/sbc_fish/SAM/raw/outputs/fish_SAM_model_Rhat2_raw.RDS")
