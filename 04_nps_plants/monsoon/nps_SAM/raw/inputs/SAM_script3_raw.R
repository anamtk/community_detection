...
mod <- readRDS(file ="/scratch/atm234/nps_plants/SAM/raw/outputs/nps_SAM_model2.RDS")
...
saveRDS(mod, 
        file ="/scratch/atm234/nps_plants/SAM/raw/outputs/nps_SAM_raw_model3.RDS")
...
mcmcplot(mod$samples,
         dir = "/scratch/atm234/nps_plants/SAM/raw/outputs/mcmcplots/SAM3")

# Get RHat per parameter ------------------------------------------------

Rhat <- mod$Rhat

saveRDS(Rhat, "/scratch/atm234/nps_plants/SAM/raw/outputs/nps_SAM_model_Rhat3_raw.RDS")
