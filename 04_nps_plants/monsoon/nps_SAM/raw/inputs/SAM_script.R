...
saveRDS(mod, 
        file ="/scratch/atm234/nps_plants/SAM/raw/outputs/nps_SAM_model_raw.RDS")
...
mcmcplot(mod$samples,
         dir = "/scratch/atm234/nps_plants/SAM/raw/outputs/mcmcplots/SAM")

# Get RHat per parameter ------------------------------------------------

Rhat <- mod$Rhat

saveRDS(Rhat, "/scratch/atm234/nps_plants/SAM/raw/outputs/nps_SAM_model_Rhat_raw.RDS")
