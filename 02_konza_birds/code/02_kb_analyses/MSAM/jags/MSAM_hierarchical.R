model{
  ...
  ## 4. Covariates on detection including average size of the species
  ### and the length of the survey period
  ...
  for(k in 1:n.species){
    ...
    ### KO: Again, I see no reason to add a small number (does not result in a folded t)
