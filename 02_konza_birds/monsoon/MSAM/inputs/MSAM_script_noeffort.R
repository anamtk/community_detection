...
mod <- jagsUI::jags(data = data_list,
                        inits = inits,
                        #inits = NULL,
                        model.file = '/scratch/atm234/konza_birds/inputs/kb_MSAM_simple_noeffort.R',
...
saveRDS(mod, 
        file ="/scratch/atm234/konza_birds/outputs/bird_MSAM_model_noeffort.RDS")
...
mcmcplot(mod$samples,
         dir = "/scratch/atm234/konza_birds/outputs/mcmcplots/MSAMnoeffort")
...
saveRDS(Rhat, "/scratch/atm234/konza_birds/outputs/bird_MSAM_modelnoeffort_Rhat.RDS")
